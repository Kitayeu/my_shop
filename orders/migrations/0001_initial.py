    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('Created', 'Created'), ('Processing', 'Processing'), ('Ready for pickup', 'Ready for pickup'), ('Shipped', 'Shipped'), ('Completed', 'Completed')], default='Created', max_length=20)),
